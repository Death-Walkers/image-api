...
const cfForm = `
  ...
  <div>
    ...
    <input class="element" id="cfphone" type="number" name="phoneno" placeholder="Phone No" autocomplete="off">
...
async function cfSubmitMessage() {
  let cfValue = {
    ...
    phone_no: document.getElementById("cfphone").value.trim(),
  ...
  ["cfname", "cfemail", "cfphone", "cfsubject", "cfmessage"].forEach(id => {
